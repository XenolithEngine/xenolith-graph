...
const GUIDES: { slug: string; title: string }[] = [
  ...
  { slug: 'react',           title: 'React adapter (@xenolithengine/react — hooks, panels, custom widgets)' },
  { slug: 'vue',             title: 'Vue 3 adapter (@xenolithengine/vue — composables, panels, custom widgets)' },
