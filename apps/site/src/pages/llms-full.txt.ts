...
function mcpSection(): string {
  ...
  lines.push('')
  lines.push('The `@xenolithengine/graph-mcp-server` package exposes these tools to any MCP client (Claude Desktop, Cursor, etc). Mutations go through the editor command bus, so undo/redo and events fire normally.')
  lines.push('')
