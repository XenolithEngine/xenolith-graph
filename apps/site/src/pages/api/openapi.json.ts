...
export const GET: APIRoute = () => {
  ...
  const spec = {
    ...
    info: {
      ...
      version: '1.0.0',
      description: 'Function-calling catalog mirroring every MCP tool exposed by `@xenolith/mcp-server`. Use this if your agent framework reads OpenAPI but not MCP directly.',
