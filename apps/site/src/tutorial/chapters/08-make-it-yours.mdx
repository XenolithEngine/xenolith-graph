...
vue: vue/Chapter08.vue
svelte: vanilla/svelte-08-make-it-yours.ts
---
...
- **MCP server** — point Claude Desktop / Cursor at `@xenolithengine/mcp-server` and ask "build me a RAG pipeline" — the AI fills your editor.
