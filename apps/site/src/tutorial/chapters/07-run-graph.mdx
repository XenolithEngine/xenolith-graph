...
vue: vue/Chapter07.vue
svelte: vanilla/svelte-07-run-graph.ts
---
...
A more featured executor ships in [`@xenolithengine/graph-plugin-runtime`](https://github.com/XenolithEngine/xenolith-graph/tree/main/packages/plugin-runtime) — type-aware, async-aware, with three engines (interpreted, codegen-JS, AssemblyScript-WASM). It's the same shape, just dialled up.
