...
|---|---|---|
| **MCP server (stdio)** | Claude Desktop, Cursor, any MCP-aware client | [`@xenolithengine/mcp-server` testing guide](https://github.com/XenolithEngine/xenolith-graph/blob/main/packages/mcp-server/TESTING.md) |
...
- A visual debugger (the `StepDebugger` is part of `@xenolithengine/editor`)
