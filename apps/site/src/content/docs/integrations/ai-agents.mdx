...
|---|---|---|
| **MCP server (stdio)** | Claude Desktop, Cursor, any MCP-aware client | [`@xenolithengine/graph-mcp-server` testing guide](https://github.com/XenolithEngine/xenolith-graph/blob/main/packages/mcp-server/TESTING.md) |
