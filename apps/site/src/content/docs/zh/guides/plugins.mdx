...
{/* EN-canonical-banner */}
English is the canonical source. If something contradicts the [English version](../../../guides/plugins/) — trust the English page. We'll re-sync translations periodically until v1.0.
:::

The editor's surface stays small; richer behaviours land as plugins or opt-in features.

## Auto-layout (`@xenolithengine/plugin-autolayout`)
