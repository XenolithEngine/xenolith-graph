...
{/* EN-canonical-banner */}
English is the canonical source. If something contradicts the [English version](../../../guides/macros-templates/) — trust the English page. We'll re-sync translations periodically until v1.0.
:::
