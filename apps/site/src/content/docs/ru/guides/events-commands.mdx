...
{/* EN-canonical-banner */}
English is the canonical source. If something contradicts the [English version](../../../guides/events-commands/) — trust the English page. We'll re-sync translations periodically until v1.0.
:::
...
```ts
import { Commands } from '@xenolithengine/editor'
