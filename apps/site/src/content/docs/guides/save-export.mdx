...
Pin types, widget defaults, and node positions are translated into `xenolith.v1` shape. Reroutes are preserved as inline knots. A public package (`@xenolithengine/comfy-import`) is planned for v0.8.
