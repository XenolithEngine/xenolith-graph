  ...
  vite: {
    ...
    resolve: {
      ...
      alias: {
        ...
        '@xenolith/theme-holographic':   new URL('../../packages/theme-holographic/src/index.ts',   import.meta.url).pathname,
        '@xenolith/plugin-autolayout/dagre': new URL('../../packages/plugin-autolayout/src/adapters/dagre.ts', import.meta.url).pathname,
        '@xenolith/plugin-autolayout/elk':   new URL('../../packages/plugin-autolayout/src/adapters/elk.ts',   import.meta.url).pathname,
        '@xenolith/plugin-autolayout':       new URL('../../packages/plugin-autolayout/src/index.ts',           import.meta.url).pathname,
      },
    },
    build: { target: 'es2022' },
