...
import { XenolithGraph, XenolithPanel, XenolithButton, XenolithControls, XenolithMiniMap } from '@xenolithengine/graph-react'
  ...
  return (
    <XenolithGraph className="xeno-host" resizeToWindow minimap onReady={onReady}>
      ...
      <XenolithPanel position="top-left" style={{ display: 'flex', flexDirection: 'column', gap: 10, width: 250 }}>
        ...
        <span style={{ fontSize: 10, color: 'var(--xeno-muted)', marginTop: -6 }}>fairqueue built from @xenolithengine/graph-plugin-runtime primitives</span>
