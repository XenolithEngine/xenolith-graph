// The fairqueue model expressed as a @xenolithengine/graph-plugin-runtime graph (generic primitives + the one
...
import { BUILTIN_PRIMITIVES, COLLECTION_PRIMITIVES, Allocate, PRIMITIVE_CATEGORY_COLORS, PRIMITIVE_ICONS, PRIMITIVE_SCHEMAS, type NodeDef } from '@xenolithengine/graph-plugin-runtime'
import type { XenolithGraphV1, XenolithNodeV1, XenolithPinV1, XenolithEdgeV1, XenolithCommentV1, WidgetSpec } from '@xenolithengine/graph-editor'
